...
selected_samples <- args[1] ## cnag_ids ofselected samples (file for testing the script:"/home/groups/compgen/lwange/isilon/data/Illumina_CryoZoo/RNA-seq/Batch1_HQ_Genomes/Samples_map2Panthera_leo.txt")
full_info <- args[2] ## Rds file with fastqs (filefor testing: "/home/groups/compgen/lwange/isilon/data/Illumina_CryoZoo/CGLZOO_01.rds")
...
pipeline_info <- readRDS(full_info) %>%
    ...
    write_csv(paste0(output_directory,"/pipeline_info.csv"))