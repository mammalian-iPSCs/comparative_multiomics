...
JOB_SCRIPT="$OUTPUT_DIRECTORY/run_rna-seq_pipeline_${REFGENIE_ALIAS}.sh"
...
module load Java
cd $OUTPUT_DIRECTORY
nextflow run nf-core/rnaseq -profile singularity -params-file $OUTPUT_DIRECTORY/nf_core_params.json -c /scratch_isilon/groups/compgen/lwange/singularity/rna_seq/cnag_rna-seq.config -resume --outdir $OUTPUT_DIRECTORY/map_2_${REFGENIE_ALIAS}
EOF
